...
program mainMatMult90
    ...
    integer::ioerr, i            ! error handler for io
  ...
  write(ioout,*)"*******************The First Matrix set Multiplication*******************"
    ...
    deallocate(A,stat=memerr)
     ...
     if (i.eq.1)  write(ioout,*)"*******************The Second Matrix set Multiplication*******************"
     if (i.eq.2)  write(ioout,*)"*******************The Third  Matrix set Multiplication*******************"
     if (i.eq.3)  write(ioout,*)"*******************The fourth Matrix set Multiplication*******************"
     if (i.eq.4)  exit
